...
$website_wendu = <<<EOL
            ...
            <div class="site-info-div" >
                ...
                <p>总部地址：<a class="click-a" href="https://www.amap.com/place/B02DB05PEH" title="地址" target="_blank">北京市海淀区西三环北路72号世纪经贸大厦B座16层1608</a>&nbsp;&nbsp;&nbsp;&nbsp;邮编：100048</p>
...
<div class="that-page-url-div hide"><a class="that-page-url-a" href="<?=get_url()?>" title="<?=$title?>_链接：<?=get_url()?>">本页链接：<?=get_url()?></a></div>
