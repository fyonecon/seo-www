...
let header_html = `
	<div class="hk_header">
		<div class="hk_header_center hk_clear">
			<a href="/home.php?route=nav&nav=home" class="hk_heaer_logo" target="_blank">
				<img src="http://oss.cswendu.com/pc.cswendu.com/fixed-img-for-js/logo.png" alt="">
			</a>
...
$(document).ready(function(){
	...
	$('.hk_header_slideDown_t1title,.hk_header-slideDown_t3_item,.hk_header_item').on('click',function(){
