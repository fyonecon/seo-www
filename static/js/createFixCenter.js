	...
	$(document).ready(function(){
		...
		if(right_host=='cs.wendu.com'||right_host == 'hn.wendu.com'||right_host == 'www.cswendu.com'||right_host == 'm.cswendu.com'){
			...
			TC_bg = "url('http://oss.cswendu.com/pc.cswendu.com/fixed-img-for-js/fix-center-bg4.png') no-repeat center center/contain"
		...
		let createFixCenterDiv=$('<div></div>');        //创建一个父div
			...
			createFixCenterDiv.addClass('fix-center-body')
		...
		$('.fix-center-body').on('click',function(){
